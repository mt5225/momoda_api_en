var cmds = [
	...
	},
	{
		...
		"parameters":[
			{ "parameter":"cmds", "des":"输入要操作的命令，可以使用数组包装多个命令", "requred":true},
			{ "parameter":"execute", "des":"输入命令的同时是否执行命令" , "requred":false, "default":false}
		],
		"examples":[
			{
				"name":"",
	...
	},
	{
		...
		"parameters":[
			{ "parameter":"cmds", "des":"输入要删除的命令", "requred":true}
		],
		"examples":[
			{
				"name":"",
